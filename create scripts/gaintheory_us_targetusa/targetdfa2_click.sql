...
foreign key(rendering_id) references targetdfa2_creatives(placement_id),
...
foreign key(designated_market_area_dma_id) references targetdfa2_designated_market_area(designated_market_area_dma_id),
